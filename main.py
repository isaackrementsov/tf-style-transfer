...
mixed_image = ml.style_transfer(
    ...
    content_layers=['block4_conv2', 'block5_conv2'], # VGG19 layers used to determine content
    style_layers=['block1_conv1', 'block2_conv1', 'block3_conv1', 'block4_conv1', 'block5_conv1'], # VGG19 layers used to determine style
    weight_content=1e1, # How much the image content should matter
    weight_style=3e-1, # How much the artistic style should matter
    weight_denoise=1e-1, # How much noise needs to be removed
...
# Save the image data
mixed_image.save('./assets/mixed_image8.jpg')
